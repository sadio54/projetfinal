...
class OrderCrudController extends AbstractCrudController
{
    ...
    public function configureActions(Actions $actions): Actions
    {
        ...
        $updateDelivery = Action::new('updateDelivery', 'Livraison en cours', 'fa-solid fa-truck-fast')->linkToCrudAction('updateDelivery');
    ...
    public function updateDelivery(AdminContext $context)
    {
        ...
        $this->addFlash('notice', "<span style='color:white;'><strong>La commande " . $order->getReference() . " est en cours de livraison</strong></span>");
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            TextField::new('user.getFullName', 'Utilisateur')->onlyOnDetail(),
